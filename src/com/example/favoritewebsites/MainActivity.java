...
public class MainActivity extends ListActivity
{
	...
	protected void onCreate(Bundle savedInstanceState)
	{
		...
		adapter = new ArrayAdapter<String>(this, R.layout.list3_item, tags);
	...
	OnItemClickListener itemClickListener = new OnItemClickListener()
	{
		...
		public void onItemClick(AdapterView<?> parent, View view, int position, long id)
		{
			...
			String urlString = getString(R.string.siteURL) + Uri.encode(savedSites.getString(tag, ""), "UTF-8");
	...
	OnItemLongClickListener itemLongClickListener = new OnItemLongClickListener()
	{
		...
		public boolean onItemLongClick(AdapterView<?> parent, View view, int position, long id)
		{
			...
			private void shareSite(String tag)
			{
				...
				startActivity(Intent.createChooser(shareIntent, getString(R.string.shareSite)));
			}
